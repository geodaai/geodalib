...
//
// PAM (Partitioning Around Medoids) / FastPAM k-medoids clustering, ported from
// csds_libgeoda (https://github.com/geodacenter/csds_libgeoda). The header
// cpp/src/clustering/pam.h is shared with the AZP initializer; this file adds
// the BUILD/LAB/FastPAM implementations that pam.h declares.
